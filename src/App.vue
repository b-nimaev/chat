    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 d-flex">
          <a @click.prevent="tohome" href="javascript:void(0)" class="logotype">
        ...
        <div class="col">
          <div class="row">
            ...
            <div class="col d-flex">
              ...
              <div @click="toggleActive" class="player" :class="{ active: playerActive }">
...
.headertop {
  ...
  .search {
    ...
    input {
      ...
      border-radius: 3px;
      border-radius: 30px;
      box-shadow: -3px 3px 1px 0px #d7ddff;
      color: #777;
    }
  }
  .player {
    ...
    cursor: pointer;
    &.active {
      background-color: $background-player-active;
    }
    img {
      width: 32px;
      height: 32px;
